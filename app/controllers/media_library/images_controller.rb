  ...
  class ImagesController < ApplicationController
    ...
    def create
      ...
      blob = ActiveStorage::Blob.create_and_upload!(
        ...
        service_name: MediaLibrary.configuration.storage_service
      )
    ...
    def per_page
      ...
      value && value.positive? ? value : MediaLibrary.configuration.per_page
    end

    def allowed_content_type?(content_type)
      return false if content_type.blank?

      allowed = MediaLibrary.configuration.allowed_content_types
